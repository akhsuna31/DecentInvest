...
export function SignupFormDemo() {
  ...
  return (
    (<div
      className="max-w-2xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black mt-16">
      <h2 className="font-bold text-5xl text-neutral-800 dark:text-neutral-200">
        Welcome to DecentInvest
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Signup now for a better future
      </p>
